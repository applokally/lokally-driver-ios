...
class _ProfileStatusCardWidgetState extends State<ProfileStatusCardWidget> {
  ...
  Widget build(BuildContext context) {
    final bool isOnline = widget.profileController.isOnline == '1';

    final Color onlineColor = Theme.of(context).primaryColor;
    final Color offlineColor = Colors.redAccent.shade400;

    final Color statusColor = isOnline ? onlineColor : offlineColor;
    final Color statusBackgroundColor = isOnline
        ? onlineColor.withValues(alpha: 0.12)
        : offlineColor.withValues(alpha: 0.12);
    final Color statusBorderColor = isOnline
        ? onlineColor.withValues(alpha: 0.22)
        : offlineColor.withValues(alpha: 0.24);
                ...
                child: Row(
                  children: [
                    ...
                    FlutterSwitch(
                      ...
                      borderRadius: 30.0,
                      padding: 3,
                      activeColor: statusBackgroundColor,
                      inactiveColor: statusBackgroundColor,
                      activeText: 'online'.tr,
                      inactiveText: 'offline'.tr,
                      activeTextColor: statusColor,
                      inactiveTextColor: statusColor,
                      showOnOff: true,
                      activeTextFontWeight: FontWeight.w700,
                      inactiveTextFontWeight: FontWeight.w700,
                      toggleColor: statusColor,
