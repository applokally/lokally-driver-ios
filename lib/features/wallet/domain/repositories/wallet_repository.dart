...
class WalletRepository implements WalletRepositoryInterface {
  ...
  Future<Response?> getLoyaltyPointList(int offset) async {
    return await apiClient.getData(
      '${AppConstants.loyaltyPointListUri}$offset',
    );
  }
  ...
  Future<Response?> getWithdrawMethodInfoList(int offset) async {
    return await apiClient.getData(
      '${AppConstants.getWithdrawMethodInfoList}$offset',
    );
  }
  ...
  Future<Response?> createWithdrawMethodInfo(
    ...
    Response response = await apiClient.postData(
      AppConstants.withdrawMethodCreate,
      fields,
    );
  ...
  Future<Response?> updateWithdrawMethodInfo(
    ...
    Response response = await apiClient.postData(
      '${AppConstants.withdrawMethodUpdate}$methodInfoId',
      fields,
    );
  ...
  Future<Response> getWithdrawPendingList(int offset) async {
    return await apiClient.getData(
      '${AppConstants.withdrawPendingListUri}$offset',
    );
  }
  ...
  Future<Response> getWithdrawSettledList(int offset) async {
    return await apiClient.getData(
      '${AppConstants.withdrawSettledListUri}$offset',
    );
  }
  ...
  Future<Response> getCashCollectHistoryList(int offset) async {
    return await apiClient.getData(
      '${AppConstants.cashCollectHistoryList}$offset',
    );
  }
  ...
  @override
  Future<Response?> getLokallyBillingOverview() async {
    return await apiClient.getData(AppConstants.locallyBillingOverviewUri);
  }

  @override
  Future<Response?> generateWeeklyCommissionBillingPix(
    String billingId,
  ) async {
    return await apiClient.postData(
      '${AppConstants.weeklyCommissionBillingPixUri}$billingId/pix',
      {},
    );
  }

  @override
  Future<Response?> generateMonthlyBillingPix(String billingId) async {
    return await apiClient.postData(
      '${AppConstants.monthlyBillingPixUri}$billingId/pix',
      {},
    );
  }
