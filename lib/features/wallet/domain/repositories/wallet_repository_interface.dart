...
abstract class WalletRepositoryInterface implements RepositoryInterface {
  ...
  Future<Response?> getLokallyBillingOverview();
  Future<Response?> generateWeeklyCommissionBillingPix(String billingId);
  Future<Response?> generateMonthlyBillingPix(String billingId);
}
