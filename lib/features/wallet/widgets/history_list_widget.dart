...
import 'package:ride_sharing_user_app/features/wallet/widgets/lokally_billing_widget.dart';
  ...
  Widget build(BuildContext context) {
    return GetBuilder<WalletController>(
      builder: (walletController) {
        if (walletController.walletTypeIndex == 0 && tabIndex == 2) {
          return const LokallyBillingWidget();
        }
        ...
        return Column(
          children: [
            ...
            if (walletController.walletTypeIndex == 0 && tabIndex == 1)
              PayableTransactionListWidget(
                walletController: walletController,
                scrollController: scrollController,
              ),
