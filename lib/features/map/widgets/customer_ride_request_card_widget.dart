                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      fromParcel
                          ? _ParcelCompleteButton(rideRequest: rideRequest)
                          : _MapRequestActions(rideRequest: rideRequest),
                    ],
                  ),
                ),
              ),
...
class _ParcelCompleteButton extends StatelessWidget {
  final TripDetail rideRequest;

  const _ParcelCompleteButton({required this.rideRequest});
                ...
                onPressed: () async {
                  if (rideRequest.paymentStatus == 'paid') {
                    ...
                    if (rideRequest.parcelInformation!.payer == 'sender') {
                      ...
                      if (Get.find<RideController>().matchedMode != null &&
                          (Get.find<RideController>().matchedMode!.distance! *
                                  1000) <=
                              Get.find<SplashController>()
                                  .config!
                                  .completionRadius!) {
...
class _MapRequestActions extends StatelessWidget {
  final TripDetail rideRequest;

  const _MapRequestActions({required this.rideRequest});
                      ...
                      onPressed: () {
                        ...
                        if (_isShowBidButton(rideRequest)) {
                          showDialog(
                            context: Get.context!,
                            builder: (_) =>
                                BiddingDialogWidget(rideRequest: rideRequest),
                          );
                          return;
                        }
                        ...
                        rideController
                          ...
                          rideRequest.parcelInformation?.weight ?? '0',
                            ...
                            .then((value) async {
                          if (value.statusCode == 200) {
                            // Permanece no mapa. A lista de solicitações não é aberta.
                            Get.find<RiderMapController>()
                                .setRideCurrentState(RideState.initial);
                      ...
                      onPressed: () async {
                        ...
                        rideController
                          ...
                          if (value.statusCode == 200) {
                            ...
                            // Permanece na MapScreen para seguir o fluxo de OTP.
                          } else {
...
class _RideRequestListCard extends StatelessWidget {
  final TripDetail rideRequest;
  final int? index;

  const _RideRequestListCard({
    required this.rideRequest,
    required this.index,
  });
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: ClipRRect(
        ...
        child: Slidable(
          key: ValueKey(rideRequest.id ?? index ?? 0),
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  _CommonDesignPart(rideRequest: rideRequest),
                  GetBuilder<RideController>(builder: (rideController) {
                    final bool isCurrentRequest = rideController
                            .pendingRideRequestModel?.data?[index ?? -1].id ==
                    ...
                    return Padding(
                      ...
                      child: isCurrentRequest && rideController.accepting
                          ? SpinKitCircle(
                              color: Theme.of(context).primaryColor,
                              size: 40.0,
                            )
                                    ...
                                    onPressed: () async {
                                      ...
                                      Get.find<RideController>()
                                        ...
                                        showSuccess: false,
                                          ...
                                          .then((value) {
                                        if (value.statusCode == 200) {
                                          // tripAcceptOrRejected fecha esta lista manualmente
                                          // e mantém a MapScreen já existente por baixo.
                                          Get.find<RideController>()
                                              .ongoingTripList()
                                              .then((ongoingResponse) async {
                                            if ((Get.find<RideController>()
                                                            .ongoingTrip ??
                                                        [])
                                                    .length <=
                                                1) {
                                              if (ongoingResponse.statusCode ==
                                                  200) {
...
bool _isShowBidButton(TripDetail rideRequest) {
  final bool bidOn = Get.find<SplashController>().config!.bidOnFare!;
            ...
            child: Column(
              ...
              children: [
                ...
                RichText(
                  text: TextSpan(
                    text:
                        '${'your_account_is_on_hold_so_you_cannot_start_trip'.tr} ',
                    style: textMedium.copyWith(
                      color: Get.isDarkMode
      ...
      children: [
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text('trip_type'.tr, style: textBold),
